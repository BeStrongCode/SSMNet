...
# an alternative for mamb a_ssm (in which causal_conv1d is needed)
try:
...
class SelectiveScanMamba(torch.autograd.Function):
    ...
    def forward(ctx, u, delta, A, B, C, D=None, delta_bias=None, delta_softplus=False, nrows=1, backnrows=1, oflex=True):
        ...
        out, x, *rest = selective_scan.fwd(u, delta, A, B, C, D, None, delta_bias, delta_softplus)
    ...
    def backward(ctx, dout, *args):
        ...
        du, ddelta, dA, dB, dC, dD, ddelta_bias, *rest = selective_scan.bwd(
